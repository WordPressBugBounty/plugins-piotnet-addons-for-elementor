...
{
    if (isset($_POST['nonce']) && wp_verify_nonce(sanitize_text_field(wp_unslash($_POST['nonce'])), 'pafe_free_nonce')) {
        global $wpdb;
        $layout = '';
        $args = [];
                    ...
                    <div class="pafe-post-list__left">
                        <div class="pafe-card-left">
                            <?php if ($layout !== 'layout_3'): ?>
                                <div class="pafe-card-left__inner"
                                    style="background-image: url('<?php echo esc_url(get_the_post_thumbnail_url()); ?>');">
                                <?php endif; ?>
                                <?php if ($layout == 'layout_3'): ?>
                                    <div class="pafe-card-left__inner-layout_3"
                    ...
                    <?php if ($index >= 2): ?>
                        <div class="pafe-card-right">
                            <div class="pafe-card-right__inner">
                                <a class="pafe-card-right__thumbnail" href="<?php echo esc_url(get_permalink()); ?>"
                                    style="background-image: url('<?php echo esc_url(get_the_post_thumbnail_url()); ?>');">
                                </a>
                                <div class="pafe-card-right__content">
                                    <a href="<?php echo esc_url(get_permalink()); ?>">
                                        <div class="pafe-card-right__title"><?php echo wp_kses_post(get_the_title()); ?></div>
                                    </a>
                                    <?php if ($excerpt == 'yes'): ?>
                                    ...
                                    <div class="pafe-card-right__info">
                                        <?php if ($date == 'yes'): ?>
                                            <span class="pafe-card-right__tag"><i
                                                    class="far fa-clock"></i><?php echo get_the_date(); ?></span>
                                        <?php endif; ?>
                                    </div>
                                </div>
                            </div>
